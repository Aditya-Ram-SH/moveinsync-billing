...
from app.routers import auth_router, billing_router, contracts_router, demo_router, stats_router, trips_router
...
app.include_router(demo_router.router, prefix="", tags=["Demo"])  # DEMO MODE - Remove after video
